...
def run(src: str, dest: str, vols: str, name: str, folder_type: str, to_skip: bool = False, console: Any = None) -> bool:
    with tempfile.TemporaryDirectory() as temp_extracted:
        ...
        with tempfile.TemporaryDirectory() as temp_converted:
            if not convert_pdf.run(temp_extracted, temp_converted, name, folder_type, to_skip, console):
                return False
